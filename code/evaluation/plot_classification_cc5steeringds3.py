...
fig, ax = plt.subplots(1,2, figsize=(8,6))#gs = GridSpec(2, 2, figure=fig)
#ax[0,0] = fig.add_subplot(gs[1, :-1])
ax[0].plot(df_1_basic_loss.Step,df_1_basic_loss.Value, label='Basic model ')
ax[0].plot(df_1_dense_loss.Step,df_1_dense_loss.Value, label='Separte dense layers')
ax[0].plot(df_1_lstm_loss.Step,df_1_lstm_loss.Value, label='Separate LSTM layers')
ax[0].plot(df_1_2nn_loss.Step,df_1_2nn_loss.Value, label='Separate NNs')
...
ax[1].plot(df_2_basic_vloss.Step,df_2_basic_vloss.Value, label='Basic model')
ax[1].plot(df_2_dense_vloss.Step,df_2_dense_vloss.Value, label='Separte dense layers')
ax[1].plot(df_2_lstm_vloss.Step,df_2_lstm_vloss.Value, label='Separate LSTM layers')

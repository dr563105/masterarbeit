...
#rgb+seg(LF)
df_6_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/segcsv/run-evaluate_ts15_ds3_Class6_cseg2_201014-0234-tag-val_loss.csv')
df_6_class_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/segcsv/run-evaluate_ts15_ds3_Class6_cseg2_201014-0234-tag-val_classification_loss.csv')
...
ax[0,0].plot(df_7_vloss.Step+1,df_7_vloss.Value,color='#407FB7', label='Only Seg')
...
ax[0,1].plot(df_7_class_vloss.Step+1,df_7_class_vloss.Value,color='#407FB7', label='Only Seg')
...
ax[1,0].plot(df_7_vel_vloss.Step+1,df_7_vel_vloss.Value,color='#407FB7', label='Only Seg')
...
ax[1,0].plot(df_6_vel_vloss[:49].Step+1,(df_6_vel_vloss[:49].Value),color='#A11035', label='RGB-G+Seg(LF)')
...
ax[1,1].plot(df_7_st_vloss.Step+1,df_7_st_vloss.Value,color='#407FB7', label='Only Seg')
...
ax[1,1].plot(df_6_st_vloss[:49].Step+1,(df_6_st_vloss[:49].Value),color='#A11035', label='RGB-G+Seg(LF)')

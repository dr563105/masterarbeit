...
df_7_vel_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/segcsv/run-evaluate_ts15_ds3_Class6_segalone_201016-1213-tag-val_velocity_loss.csv')
...
#ax[0,0].plot(df_7_loss.Step+1,df_7_loss.Value, label='Dataset 3 2LSTMS Loss')
ax[0,0].plot(df_7_vloss.Step+1,df_7_vloss.Value,color='#57AB27', label='segmented image')
#ax[0,0].plot(df_3_loss.Step+1,df_3_loss.Value, label='Dataset 3 4LSTMS Loss')
#ax[0,0].plot(df_3_vloss.Step[:49]+1,df_3_vloss[:49].Value,color='#646567', label='increase segmented to 8')
...
#ax[1,0].plot(df_7_class_loss.Step+1,df_7_class_loss.Value, label='Dataset 3 Training Classification Loss')
ax[0,1].plot(df_7_class_vloss.Step+1,df_7_class_vloss.Value,color='#57AB27', label='segmented image')
#ax[1,0].plot(df_3_class_loss.Step+1,df_3_class_loss.Value, label='Dataset 3 Training Classification Loss')
#ax[0,1].plot(df_3_class_vloss.Step[:49]+1,df_3_class_vloss[:49].Value,color='#646567', label='increase segmented to 8')
...
#ax[1,0].plot(df_7_vel_loss.Step+1,df_7_vel_loss.Value, label='Dataset 3 Training Velocity Loss')
ax[1,0].plot(df_7_vel_vloss.Step+1,df_7_vel_vloss.Value,color='#57AB27', label='segmented image')
#ax[1,0].plot(df_3_vel_loss.Step+1,df_3_vel_loss.Value, label='Dataset 3 Training Velocity Loss')
#ax[1,0].plot(df_3_vel_vloss.Step[:49]+1,df_3_vel_vloss[:49].Value,color='#646567', label='increase segmented to 8')
...
#ax[1,1].plot(df_7_st_loss.Step+1,df_7_st_loss.Value, label='Dataset 3 Training Steering Loss')
ax[1,1].plot(df_7_st_vloss.Step+1,df_7_st_vloss.Value,color='#57AB27', label='segmented image')
#ax[1,1].plot(df_3_st_loss.Step+1,df_3_st_loss.Value, label='Dataset 3 Training Steering Loss')
#ax[1,1].plot(df_3_st_vloss.Step[:49]+1,df_3_st_vloss[:49].Value,color='#646567', label='increase segmented to 8')

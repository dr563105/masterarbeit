...
ax[0,0].plot(df_1_vloss.Step[:49]+1,df_1_vloss[:49].Value,color='#D85C41', label='Only Seg')
ax[0,0].plot(df_2_vloss.Step+1,df_2_vloss.Value,color='#57AB27', label='100k RGB-G+Depth(EF)')
ax[0,0].plot(df_3_vloss.Step[:49]+1,df_3_vloss[:49].Value,color='#646567', label='224k RGB-G+Depth(EF)')
...
ax[0,1].plot(df_1_class_vloss[:49].Step+1,df_1_class_vloss[:49].Value,color='#D85C41', label='Only RGB-G')
ax[0,1].plot(df_2_class_vloss.Step+1,df_2_class_vloss.Value,color='#57AB27', label='100k RGB-G+Depth(EF)')
ax[0,1].plot(df_3_class_vloss.Step[:49]+1,df_3_class_vloss[:49].Value,color='#646567', label='224k RGB-G+Depth(EF)')
...
ax[1,0].plot(df_1_vel_vloss.Step[:49]+1,df_1_vel_vloss[:49].Value,color='#D85C41' label='Only Seg')
ax[1,0].plot(df_2_vel_vloss.Step+1,df_2_vel_vloss.Value,color='#57AB27', label='100k RGB-G+Depth(EF)')
ax[1,0].plot(df_3_vel_vloss.Step[:49]+1,df_3_vel_vloss[:49].Value,color='#646567', label='224k RGB-G+Depth(EF)')
...
ax[1,1].plot(df_1_st_vloss.Step[:49]+1,df_1_st_vloss[:49].Value,color='#D85C41', label='Only Seg')
ax[1,1].plot(df_2_st_vloss.Step+1,df_2_st_vloss.Value,color='#57AB27', label='100k RGB-G+Depth(EF)')
ax[1,1].plot(df_3_st_vloss.Step[:49]+1,df_3_st_vloss[:49].Value,color='#646567',label='224k RGB-G+Depth(EF)')

...
ax1.plot(df_2_val.Step,df_2_val.Value,color='#CC071E', label='Dataset 3 Validation Loss')
ax1.set_title('Overall Loss')
ax1.set_ylabel('Loss')
ax1.legend()

ax2 = fig.add_subplot(gs[1, :-1])
ax2.plot(df_1_accel.Step+1,df_1_accel.Value,color='#57AB27', label='Training Loss')
ax2.plot(df_2_accel.Step+1,df_2_accel.Value,color='#CC071E', label='Validation Loss')
...
ax3.plot(df_1_st.Step+1,df_1_st.Value,color='#57AB27', label='Training Loss')
ax3.plot(df_2_st.Step+1,df_2_st.Value,color='#CC071E', label='Validation Loss')

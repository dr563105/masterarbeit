...
df_3_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/convtweakscsv/run-evaluate_ts15_ds3_Class5_conv16_201013-0857-tag-val_loss.csv')
df_3_class_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/convtweakscsv/run-evaluate_ts15_ds3_Class5_conv16_201013-0857-tag-val_classification_loss.csv')
df_3_st_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/convtweakscsv/run-evaluate_ts15_ds3_Class5_conv16_201013-0857-tag-val_st_loss.csv')
df_3_vel_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/convtweakscsv/run-evaluate_ts15_ds3_Class5_conv16_201013-0857-tag-val_velocity_loss.csv')
...
ax[0,0].plot(df_1_vloss.Step[:49]+1,df_1_vloss[:49].Value,color='#CC071E', label='colour image')
#ax[0,0].plot(df_2_loss.Step+1,df_2_loss.Value, label='Dataset 3 2LSTMS Loss')
ax[0,0].plot(df_2_vloss.Step+1,df_2_vloss.Value,color='#57AB27', label='depth image')
#ax[0,0].plot(df_3_loss.Step+1,df_3_loss.Value, label='Dataset 3 4LSTMS Loss')
#ax[0,0].plot(df_3_vloss.Step[:49]+1,df_3_vloss[:49].Value,color='#646567', label='increase depth to 8')
...
ax[0,1].plot(df_1_class_vloss[:49].Step+1,df_1_class_vloss[:49].Value,color='#CC071E', label='colour image')
#ax[1,0].plot(df_2_class_loss.Step+1,df_2_class_loss.Value, label='Dataset 3 Training Classification Loss')
ax[0,1].plot(df_2_class_vloss.Step+1,df_2_class_vloss.Value,color='#57AB27', label='depth image')
#ax[1,0].plot(df_3_class_loss.Step+1,df_3_class_loss.Value, label='Dataset 3 Training Classification Loss')
#ax[0,1].plot(df_3_class_vloss.Step[:49]+1,df_3_class_vloss[:49].Value,color='#646567', label='increase depth to 8')
...
ax[1,0].plot(df_1_vel_vloss.Step[:49]+1,df_1_vel_vloss[:49].Value,color='#CC071E', label='colour image')
#ax[1,0].plot(df_2_vel_loss.Step+1,df_2_vel_loss.Value, label='Dataset 3 Training Velocity Loss')
ax[1,0].plot(df_2_vel_vloss.Step+1,df_2_vel_vloss.Value,color='#57AB27', label='depth image')
#ax[1,0].plot(df_3_vel_loss.Step+1,df_3_vel_loss.Value, label='Dataset 3 Training Velocity Loss')
#ax[1,0].plot(df_3_vel_vloss.Step[:49]+1,df_3_vel_vloss[:49].Value,color='#646567', label='increase depth to 8')
...
ax[1,1].plot(df_1_st_vloss.Step[:49]+1,df_1_st_vloss[:49].Value,color='#CC071E', label='colour image')
#ax[1,1].plot(df_2_st_loss.Step+1,df_2_st_loss.Value, label='Dataset 3 Training Steering Loss')
ax[1,1].plot(df_2_st_vloss.Step+1,df_2_st_vloss.Value,color='#57AB27', label='depth image')
#ax[1,1].plot(df_3_st_loss.Step+1,df_3_st_loss.Value, label='Dataset 3 Training Steering Loss')
#ax[1,1].plot(df_3_st_vloss.Step[:49]+1,df_3_st_vloss[:49].Value,color='#646567', label='increase depth to 8')

...
ax[0,0].plot(df_3_vloss.Step[:49]+1,df_3_vloss[:49].Value,color='#CC071E', label='224k RGB-G+Seg(EF)')
...
ax[0,1].plot(df_3_class_vloss.Step[:49]+1,df_3_class_vloss[:49].Value,color='#CC071E', label='224k RGB-G+Seg(EF)')
...
ax[1,0].plot(df_3_vel_vloss.Step[:49]+1,df_3_vel_vloss[:49].Value,color='#CC071E', label='224k RGB-G+Seg(EF)')
...
ax[1,1].plot(df_3_st_vloss.Step[:49]+1,df_3_st_vloss[:49].Value,color='#CC071E',label='224k RGB-G+Seg(EF)')

...
ax1.plot(df_1_val.Step+1,df_1_val.Value, color ='#CC071E' ,label='Dataset 3 Validation Loss')
...
ax2.plot(df_2_loss.Step+1,(df_2_loss.Value),color ='#57AB27' , label='Dataset 3 Training Loss')
ax2.plot(df_2_val.Step+1,(df_2_val.Value),color ='#CC071E' , label='Dataset 3 Validation Loss')

...
ax1.plot(df_1_loss.Step+1,df_1_loss.Value, label='Dataset 3 3LSTMs Loss')
ax1.plot(df_1_vloss.Step+1,df_1_vloss.Value, label='Dataset 3 3LSTMs Loss')
ax1.plot(df_2_loss.Step+1,df_2_loss.Value, label='Dataset 3 2LSTMS Loss')
ax1.plot(df_2_vloss.Step+1,df_2_vloss.Value, label='Dataset 3 2LSTMS Loss')
...
ax2.plot(df_1_class_loss.Step+1,df_1_class_loss.Value, label='Dataset 3 Training Classification Loss')
ax2.plot(df_1_class_vloss.Step+1,df_1_class_vloss.Value, label='Dataset 3 Validation Classification Loss')
ax2.plot(df_2_class_loss.Step+1,df_2_class_loss.Value, label='Dataset 3 Training Classification Loss')
ax2.plot(df_2_class_vloss.Step+1,df_2_class_vloss.Value, label='Dataset 3 Validation Classification Loss')
...
ax3.plot(df_1_st_loss.Step+1,df_1_st_loss.Value, label='Dataset 3 Training Steering Loss')
ax3.plot(df_1_st_vloss.Step+1,df_1_st_vloss.Value, label='Dataset 3 Validation Steering Loss')
ax3.plot(df_2_st_loss.Step+1,df_2_st_loss.Value, label='Dataset 3 Training Steering Loss')
ax3.plot(df_2_st_vloss.Step+1,df_2_st_vloss.Value, label='Dataset 3 Validation Steering Loss')
...
ax4.plot(df_1_vel_loss.Step+1,df_1_vel_loss.Value, label='Dataset 3 Training Velocity Loss')
ax4.plot(df_1_vel_vloss.Step+1,df_1_vel_vloss.Value, label='Dataset 3 Validation Velocity Loss')
ax4.plot(df_2_vel_loss.Step+1,df_2_vel_loss.Value, label='Dataset 3 Training Velocity Loss')
ax4.plot(df_2_vel_vloss.Step+1,df_2_vel_vloss.Value, label='Dataset 3 Validation Velocity Loss')

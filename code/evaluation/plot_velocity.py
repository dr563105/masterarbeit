...
df_1_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/velocitycsv/run-evaluate_ts15_ds3_Class4_2_201002-1555(3LSTMs split)-tag-val_loss.csv')
df_1_class_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/velocitycsv/run-evaluate_ts15_ds3_Class4_2_201002-1555(3LSTMs split)-tag-val_classification_loss.csv')
df_1_st_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/velocitycsv/run-evaluate_ts15_ds3_Class4_2_201002-1555(3LSTMs split)-tag-val_st_loss.csv')
df_1_vel_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/velocitycsv/run-evaluate_ts15_ds3_Class4_2_201002-1555(3LSTMs split)-tag-val_velocity_loss.csv')
...
df_4_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/velocitycsv/run-evaluate_ts15_ds3_Class4_customlossnew_201012-0926-tag-val_loss.csv')
df_4_class_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/velocitycsv/run-evaluate_ts15_ds3_Class4_customlossnew_201012-0926-tag-val_classification_loss.csv')
df_4_st_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/velocitycsv/run-evaluate_ts15_ds3_Class4_customlossnew_201012-0926-tag-val_st_loss.csv')
df_4_vel_vloss = pd.read_csv('/home/kaladin/Documents/arbeit/real/code/evaluation/velocitycsv/run-evaluate_ts15_ds3_Class4_customlossnew_201012-0926-tag-val_velocity_loss.csv')
...
ax[0,0].plot(df_1_vloss.Step+1,df_1_vloss.Value,color='#CC071E', label='a model')
#ax[0,0].plot(df_2_loss.Step+1,df_2_loss.Value, label='Dataset 3 2LSTMS Loss')
ax[0,0].plot(df_2_vloss.Step+1,df_2_vloss.Value,color='#57AB27', label='b model')
#ax[0,0].plot(df_3_loss.Step+1,df_3_loss.Value, label='Dataset 3 4LSTMS Loss')
ax[0,0].plot(df_3_vloss.Step[:49]+1,df_3_vloss[:49].Value,color='#646567', label='c model')
...
ax[0,1].plot(df_1_vel_vloss.Step+1,df_1_vel_vloss.Value,color='#CC071E', label='a model')
#ax[0,1].plot(df_2_vel_loss.Step+1,df_2_vel_loss.Value, label='Dataset 3 Training Velocity Loss')
ax[0,1].plot(df_2_vel_vloss.Step+1,df_2_vel_vloss.Value,color='#57AB27', label='b model')
#ax[0,1].plot(df_3_vel_loss.Step+1,df_3_vel_loss.Value, label='Dataset 3 Training Velocity Loss')
ax[0,1].plot(df_3_vel_vloss.Step[:49]+1,df_3_vel_vloss[:49].Value,color='#646567', label='c model')
#ax[0,1].plot(df_4_vel_vloss[:49].Step+1,(df_4_vel_vloss[:49].Value*1000),color='#00549F', label='weighted/1000')
ax[0,1].plot(df_4_vel_vloss[:49].Step+1,(df_4_vel_vloss[:49].Value*1000),color='#00549F', label='weightedx1000')
ax[0,1].set_title('Velocity Loss')
...
ax[1,0].plot(df_1_class_vloss.Step+1,df_1_class_vloss.Value,color='#CC071E', label='a model')
#ax[1,0].plot(df_2_class_loss.Step+1,df_2_class_loss.Value, label='Dataset 3 Training Classification Loss')
ax[1,0].plot(df_2_class_vloss.Step+1,df_2_class_vloss.Value,color='#57AB27', label='b model')
#ax[1,0].plot(df_3_class_loss.Step+1,df_3_class_loss.Value, label='Dataset 3 Training Classification Loss')
ax[1,0].plot(df_3_class_vloss.Step[:49]+1,df_3_class_vloss[:49].Value,color='#646567', label='c model')
...
ax[1,1].plot(df_1_st_vloss.Step+1,df_1_st_vloss.Value,color='#CC071E', label='a model')
#ax[1,1].plot(df_2_st_loss.Step+1,df_2_st_loss.Value, label='Dataset 3 Training Steering Loss')
ax[1,1].plot(df_2_st_vloss.Step+1,df_2_st_vloss.Value,color='#57AB27', label='b model')
#ax[1,1].plot(df_3_st_loss.Step+1,df_3_st_loss.Value, label='Dataset 3 Training Steering Loss')
ax[1,1].plot(df_3_st_vloss.Step[:49]+1,df_3_st_vloss[:49].Value,color='#646567', label='c model')

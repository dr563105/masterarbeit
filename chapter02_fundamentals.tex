...
range and velocity of objects. A common sensor in weather forecast which is known for its
...
technique are  \cite{Datafusion3}, \cite{Datafusion2}, \cite{kalmanfilterpaper1},
\cite{kalmanfilterpaper2}.

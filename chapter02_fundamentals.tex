...
performance measure P \cite{mitchell1996m}\todo{make this as quote}. With experience, the algorithm can improve its
performance.
...
\begin{figure}[h]
    ...
    \input{figures/inkscape/earlyfusion1.pdf_tex}
...
\begin{figure}[h]
    \centering
    \def\svgwidth{\textwidth}
    \input{figures/inkscape/convlayers.pdf_tex}
    \caption{CNN architecture}
    \label{fig:cnnarchitecture1}
\end{figure}

\begin{figure}[h]
    \centering
    \def\svgwidth{\textwidth}
    \input{figures/inkscape/latefusion.pdf_tex}
    \caption{Late Fusion}
...
%    \centering
%    \def\svgwidth{\textwidth}
%    \input{figures/inkscape/cnnFC.pdf_tex}
...
%%	\centering
%    \includegraphics[width=0.3\textwidth]{figures/inkscape/depthsensor2.png} %use full path to know the location of pdftex
%    \caption{Working of depth camera}
%    \label{fig:depthcamera1}
%\end{wrapfigure}

...
\begin{figure}[!ht]
    \centering
    \def\svgwidth{\textwidth}
    \input{figures/inkscape/colourvsdepth.pdf_tex} %use full path to know the location of pdftex
...
\begin{figure}[!ht]
    \centering
    \def\svgwidth{\textwidth}
    \input{figures/inkscape/fusionlosses.pdf_tex} %use full path to know the location of pdftex

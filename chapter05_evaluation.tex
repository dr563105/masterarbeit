...
hyperparameter setting. Since hyperparameters are very problem-dependent,
whenever something related to this setting is altered, the changes
are mentioned.
...
In addition to episode-based training, there is a need for an evaluation that captures the
performance of the EGO vehicle in the simulated environment. The EGO vehicle is started and
allowed to drive using the predicted outputs. Then it is
...
Since acceleration and steering values in LGSVL range from {-1} to {1},
...
\begin{figure}[!ht]
    ...
    \input{figures/inkscape/ccecompareRadar.pdf_tex}
...
\begin{figure}[!ht]
    ...
    \input{figures/inkscape/100kvs200kRadar.pdf_tex}

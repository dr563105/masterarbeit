...
The images are fed into the models shown in figure \ref{velocitycompareNN} and results are
...
\begin{figure}[!ht]
	\centering
    \def\svgwidth{\textwidth}
    \input{figures/inkscape/velocitycomparelosses.pdf_tex} %use full path to know the location of pdftex
